...
- **Cancellation Limits**: Timeouts *do not* cancel underlying Prisma queries. They only prevent the worker process from locking the Node.js event loop indefinitely.
