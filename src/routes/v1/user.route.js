...
router
  .route('/')
  .post(auth('create:users:any'), validate(userValidation.createUser), userController.createUser)
  .get(auth('read:users:any'), validate(userValidation.getUsers), userController.getUsers);
